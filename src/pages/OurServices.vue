    ...
    <div class="container page-content">
      <Service>
        <template v-slot:image>
          <g-image src="~/assets/images/services/placeholder.png"/>
        </template>
      ...
      <Service>
        ...
        <p>Our program consists of 5 critical components, which are consistent with our experience and with the industry standard as generally recommended throughout the field, including The Workplace Violence Prevention and Intervention National Standard created by ASIS and SHRM (2011)*. This program is outlined in our Prevention Program.</p>
      </Service>
      ...
      <Service class="service-row-last">
        <template v-slot:image>
          <g-image src="~/assets/images/services/placeholder.png"/>
        </template>
